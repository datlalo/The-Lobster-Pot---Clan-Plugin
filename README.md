...
Access is checked inside the RuneLite client by reading the logged-in character's own clan data and allowing the plugin only
...
broadcasts, upcoming events, and discord bot-managed member profile details such as rank, join date, points,
